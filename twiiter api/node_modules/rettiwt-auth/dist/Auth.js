...
// MODELS
var AuthCredential_1 = require("./models/data/AuthCredential");
var LoginSubtask_1 = require("./models/payloads/LoginSubtask");
...
var Auth = /** @class */ (function () {
     ...
     */
    Auth.prototype.executeSubtask = function (url, credential, payload) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios_1.default.post(url, payload, {
                            headers: __assign({}, credential.toHeader()),
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.executeSubtask(Login_1.ELoginUrls.GUEST_TOKEN, cred, undefined).then(function (res) {
    ...
    Auth.prototype.getUserCredential = function (accCred) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getGuestCredential()];
                    case 1:
                        cred = _a.sent();
                        flowToken = '';
                        // Initiating the login process
                        return [4 /*yield*/, this.executeSubtask(Login_1.ELoginUrls.INITIATE_LOGIN, cred, undefined).then(function (res) {
                    ...
                    case 2:
                        ...
                        _loop_1 = function (i) {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        payload = this_1.getSubtaskPayload(this_1.subtasks[i], flowToken, accCred);
                                        // Executing the subtask
                                        return [4 /*yield*/, this_1.executeSubtask(Login_1.ELoginUrls.LOGIN_SUBTASK, cred, payload)
                                                .then(function (res) {
                                                /**
